...
let actionsForFindingTraces = [
  ...
  },
  {
    ...
    task: true,
    instructions: 1,
    async variantsOfChoiceFunction(variant, player) {
      let number = +variant;
      switch (number) {
        case 1:
  ...
  },
  {
    ...
    description:
      "Герой знаходить стародавній кам'яний моноліт, який колись був вартовим порталом між світами. Ви звертаєтеся до каменя з проханням про допомогу. \n" +
      "Камінь відкриває вам видіння, в якому показано, що квітка була викрадена істотами, які з'явилися з темного порталу в Забороненому Лісі. \n" +
      "Ви також бачить обличчя головного викрадача – тіньового мага, який планує використати квітку для своєї темної магії.",
    result:
      "Ви отримуєте підтвердження про те, куди ведуть сліди викрадачів, і дізнається про можливу причетність чаклуна.",
    task: false,
    instructions: 1,
  ...
  },
  {
    ...
    descriptionAfterTask:
      ...
      "'Сила води в моїх жилах, даруй мені силу, спритність і розум!'",
    result:
  ...
  },
  {
    ...
    descriptionAfterTask:
      "Вдячні ящери дарують герою чарівні чоботи, що збільшують його спритність(+2), дозволяючи швидше рухатися і ухилятися від нападів.",
    result:
      "Герой отримує чоботи, що збільшують його спритність, і здобуває можливість швидше пересуватися та уникати небезпек.",
    task: true,
    instructions: 1,
    async variantsOfChoiceFunction(variant, player) {
      let number = +variant;
...
const executeAllTasksRandomly = async (player) => {
